...
import { addFavoritesToDB, deleteFavoriteProducts } from '../services/favorites';
  ...
  return (
    <IconButton onClick={() => {
      ...
      if (isFavorite) {
        ...
        // console.log('after DEL', favoritesArr);
        deleteFavoriteProducts(itemId).then((favoritesList) => {
          console.log('favor list =', favoritesList.products);
